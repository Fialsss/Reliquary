...
| Skin ritirate da una stagione vecchia (Impostazioni → Percorsi → Build vecchie): Glacier, Dust Line, Racer, Union Jack… sulle armi la cui mesh non è cambiata da allora | Funziona (Y2S3 Blood Orchid: 230 coppie skin/arma su 9 armi, 98 skin). Le skin che sono solo una tinta (Masonry Ruby, Cyan…) sono escluse |
