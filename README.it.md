...
| Pack Blender dell'operatore: uniformi e copricapi, armi col caricatore, skin d'arma (anche mimetiche), mirini e ciondoli in un unico `.blend` | Funziona (78 operatori sulla build attuale; provato in Blender 5.2). L'Holo A arriva da una build vecchia (sotto) |
| L'intero catalogo del gioco con le sue immagini: ogni skin d'arma (4.765) e ciondolo (2.489), con stagioni, rarità e gradi | Funziona. Per esportare un oggetto serve che il gioco l'abbia installato o scaricato; gli altri sono segnati *Da scaricare* |
| Skin ritirate da una stagione vecchia (Impostazioni → Percorsi → Build vecchie): Glacier, Dust Line, Racer, Union Jack… su tutte le armi dell'epoca | Funziona (Y2S3 Blood Orchid: 2.033 coppie skin/arma su 68 armi, 338 skin; Glacier su tutte le 39 armi per cui il gioco la elenca). Dove la mesh di oggi è stata rifatta (G36C, AUG, MP5… 50 armi) la skin arriva sulla sua mesh del 2017, caricatore compreso. Quelle che sono una tinta di un solo foglio (Ruby, Topaz, Cyan) arrivano nel loro colore, letto dai materiali della build vecchia |
| Ciondoli ritirati e Holo A da una stagione vecchia: i ciondoli dell'anno 1 (8 Ball, le Beta Icon, i chibi…) e l'EOTech del 2017 | Funziona (Y2S3: 426 ciondoli, 230 dei 231 dell'anno 1, compresi i ranked di Black Ice; ogni parte col suo foglio e il suo colore, letti dai materiali della build vecchia: chibi dorati, metalli dei gradi, il pennacchio di Velvet Shell; l'Holo A con colori semplici: quella build ha la forma ma non le texture) |
